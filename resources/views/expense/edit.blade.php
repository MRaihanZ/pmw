        ...
        <form action="" method="post" class="p-6">
            ...
            <div class="mb-4">
                ...
                <select id="category" name="category"
                    ...
                    <option value="transport"@if ($transaction->category == 'transport') selected @endif>Transport</option>
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="3" placeholder="Enter Expense description"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">{{ $transaction->description }}</textarea>
            </div>
